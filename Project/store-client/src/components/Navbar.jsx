...
import { Cross, User, Users, X } from 'lucide-react'
        ...
        <>
            <div className='w-screen h-14 shadow-purple-500 shadow-md flex flex-row justify-center items-center'>
                ...
                <div className='w-[40%] h-full flex justify-end items-center '>
                    ...
                    <button className="h-9 w-9 flex justify-center items-center border-2  rounded-full hover:border-purple-500 hover:text-purple-500 ml-4 shadow-md" onClick={() => { setShowLogin(!showLogin) }}>
            ...
            {showLogin && (
                <div className="absolute top-0 left-0 z-50 h-screen w-screen flex justify-center items-center bg-black/40 ">
                    <div className='h-[60vh] w-1/3 flex flex-col justify-center items-center bg-white shadow-2xl rounded-md'>
                        <div className='h-full w-full flex flex-col justify-center items-center text-lg font-semibold'>
                            <div className="w-[80%] flex flex-row justify-center items-center">
                                <h1 className='w-1/3 text-left my-8 font-bold text-purple-500'>Login</h1>
